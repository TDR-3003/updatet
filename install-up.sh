...
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/ryz-code/autoscript-vpn-backup/master/update/menu.sh?token=GHSAT0AAAAAABYCZRRSJZZHB25PUNFNU4YYYZIRXQA" && chmod +x /usr/bin/menu
